...
module mudguard_cutout() {
    intersection () {
        ...
        union() {
            ...
            translate([-wheel_width/2,-wheel_width/2,-mudguard_intersecton/2])
            cube([mudguard_intersecton,wheel_width/2,mudguard_intersecton],false);
        }
        rotate([90,0,10])
        union() {
            translate([0,0,-mudguard_intersecton/2])
...
module outer_bevel() {
    ...
    third_layer = 10;
    third_layer_radius = mudguard_inner_radus-3.5;
    fourth_layer_radius = third_layer_radius-7;
